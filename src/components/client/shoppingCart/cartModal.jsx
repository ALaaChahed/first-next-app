...
80 py-4 px-4 shadow-[0_5px_15px_0_rgba(0,0,0,.15)] rounded-md transitionopacity duration-500 ${
...
<div id="a-exclure">
<button className="hover:bg-emerald-50 transition-colors roundedfull duration-500 p-1"
onClick={() => removeItem(item.id)}> <DeleteIcon color="secondary"/>
</button>
</div>
</div>
))}
...
{/* zone d'impression */}
<button
className="bg-emerald-50 hover:bg-emerald-500 hover:textwhite transition-colors duration-500 text-emerald-500 py-3 px-5 rounded-md w-100"
onClick={()=> window.print()}
>
Imprimer
</button>
<button className="bg-amber-50 hover:bg-amber-500 hover:text-white transition-colors duration-500 text-amber-500 py-3 px-5 rounded-md w-100"
